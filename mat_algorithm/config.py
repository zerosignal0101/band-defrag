...
def get_config():
    ...
    Prepare parameters:
        --algorithm_name <algorithm_name>
            specifiy the mat_algorithm, including `["mat", "mat_dec"]`
        --experiment_name <str>
    ...
    # save parameters
    parser.add_argument("--save_interval", type=int, default=5000, help="time duration between contiunous twice models saving.")
