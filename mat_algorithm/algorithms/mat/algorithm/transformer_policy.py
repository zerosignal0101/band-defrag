import torch
import numpy as np
from mat_algorithm.utils.util import update_linear_schedule
from mat_algorithm.utils.util import get_shape_from_obs_space, get_shape_from_act_space
from mat_algorithm.algorithms.utils.util import check
from mat_algorithm.algorithms.mat.algorithm.ma_transformer import MultiAgentTransformer
...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        if self.algorithm_name in ["mat", "mat_dec"]:
            from mat_algorithm.algorithms.mat.algorithm.ma_transformer import MultiAgentTransformer as MAT
        else:
